...
export function __wbg_nes_free(a: number): void;
export function nes_new(a: number, b: number, c: number, d: number): void;
export function nes_softReset(a: number): void;
export function nes_nextFrame(a: number): void;
...
export function nes_getUpdatedTilesCount(a: number): number;
...
export function nes_clearAudioBuffer(a: number): void;
export function nes_initPanicHook(): void;
