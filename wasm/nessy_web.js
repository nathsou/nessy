...
export class Nes {
    ...
    */
    static new(rom, sample_rate) {
        try {
            ...
            wasm.nes_new(retptr, ptr0, len0, sample_rate);
    ...
    */
    nextSamples(audio_buffer) {
        ...
        const ret = wasm.nes_nextSamples(this.__wbg_ptr, ptr0, len0, addHeapObject(audio_buffer));
        return ret !== 0;
    }
    /**
    ...
    */
    saveState() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.nes_saveState(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    loadState(data) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.nes_loadState(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('nessy_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
