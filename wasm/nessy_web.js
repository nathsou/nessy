...
export class Nes {
    ...
    static initPanicHook() {
        wasm.nes_initPanicHook();
    }
    /**
    ...
    static new(rom, sample_rate) {
        ...
        const ret = wasm.nes_new(ptr0, len0, sample_rate);
        if (ret[2]) {
    ...
    nextFrame(buffer) {
        ...
        wasm.nes_nextFrame(this.__wbg_ptr, ptr0, len0, buffer);
    }
    /**
     * @param {Float32Array} audio_buffer
     * @returns {boolean}
     */
    nextSamples(audio_buffer) {
        var ptr0 = passArrayF32ToWasm0(audio_buffer, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        const ret = wasm.nes_nextSamples(this.__wbg_ptr, ptr0, len0, audio_buffer);
        return ret !== 0;
    }
    /**
     * @param {Uint8Array} buffer
    ...
    fillFrameBuffer(buffer) {
        var ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.nes_fillFrameBuffer(this.__wbg_ptr, ptr0, len0, buffer);
    }
    /**
     ...
     */
    saveState() {
        const ret = wasm.nes_saveState(this.__wbg_ptr);
    ...
    loadState(data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.nes_loadState(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    fillAudioBuffer(buffer, avoid_underruns) {
        var ptr0 = passArrayF32ToWasm0(buffer, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.nes_fillAudioBuffer(this.__wbg_ptr, ptr0, len0, buffer, avoid_underruns);
    }
    clearAudioBuffer() {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('nessy_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
